...
//        Create space functionaolity
        ...
        UploadPic.sendKeys("D:\\SetProfileImage\\download (3).jpg");
...
// Now select the option (Ant Design renders options as div/span inside dropdown)
        ...
        WebElement createBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("/html/body/div[5]//button[2] | /html/body/div[6]//button[2] | /html/body/div[7]//button[2] | /html/body/div[8]//button[2]")));
        createBtn.click();
...
//        By.xpath("/html/body/div[7]/div/div[2]/div/div[1]/div/div[3]/button[2]")));
        ...
        WebElement UploadPic = wait.until(ExpectedConditions.presenceOfElementLocated(
                By.cssSelector("input[type='file']")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].style.display='block';", UploadPic);
        UploadPic.sendKeys("D:\\SetProfileImage\\afac2150-4f78-4879-8303-f8e70985c7ab.jpg");
...
//        Wait for upload file
    ...
    public void chatMediaAttach() throws InterruptedException,IOException {
        ...
        WebElement UploadPic = wait.until(ExpectedConditions.presenceOfElementLocated(
                By.cssSelector("input[type='file']")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].style.display='block';", UploadPic);
        UploadPic.sendKeys("D:\\SetProfileImage\\Exploring 37 Curly Hairstyles Men_ Diverse Looks….jpg");
        UploadPic.sendKeys("D:\\SetProfileImage\\afac2150-4f78-4879-8303-f8e70985c7ab.jpg");
        UploadPic.sendKeys("D:\\SetProfileImage\\pexels-italo-melo-881954-2379005.jpg");
...
//        upload1.sendKeys(Keys.ENTER);
    ...
    @Test (dependsOnMethods = {"chatMediaAttach"})
    public void CreateFlow() throws InterruptedException, IOException {

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));

        WebElement SpaceArrowBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[@id=\"Layout\"]/div/div[2]/div[1]/div/div/div[1]/div[3]/button")));
        SpaceArrowBtn.click();


        List<WebElement> SpaceMenu = driver.findElements(By.cssSelector("body > div:nth-child(3) > div > ul"));

        WebElement CreateFlowOpt = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[contains(text(),'Create Flow')]")));
        CreateFlowOpt.click();
